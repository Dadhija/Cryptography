...
Original file is located at
    https://colab.research.google.com/drive/18M8nPYdef6XQZASJ3ZU9oqoylx3g7YH6
"""
...
def bruteforce(key_with_error):
  ...
  for i in permutations:
    lst = list(i)
    correct_key = key_with_error[:54] + ''.join(lst) + key_with_error[56:];
...
def hash_collision(plain2):
  ...
  permutations = itertools.product(range(0,256), repeat=3)
    
  lstplain2 = list(possible_hash)
  for i in permutations:
    lstplain2[19] = i[0];
    lstplain2[45] = i[1];
    lstplain2[59] = i[2]; 
    possible_hash = bytes(lstplain2)
